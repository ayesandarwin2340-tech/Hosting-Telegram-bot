...
# Railway dashboard ကနေ ထည့်ပေးရမယ့် variables
TOKEN = os.environ.get('BOT_TOKEN')
OWNER_ID = int(os.environ.get('OWNER_ID', '0'))  # Default value 0 if not set
ADMIN_ID = int(os.environ.get('ADMIN_ID', '0'))  # Default value 0 if not set
...
if not UPDATE_CHANNEL:
    raise ValueError("UPDATE_CHANNEL environment variable is not set!")
